...
const Skill = () => {
  return (
    <>
      <h2 className="font-bold text-8xl mt-64 w-full text-center md:text-[57px] ">Skills</h2>
      <div className="w-full h-screen lg:h-[70vh] relative flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark">
        <motion.div
          className="flex items-center justify-center rounded-full font-semibold bg-dark text-light
